...
# Domain verification
resource "cloudflare_record" "dropdrape_migadu_verify" {
  zone_id = local.dropdrape_zone_id
  name    = "@"
  content = "hosted-email-verify=njphrs27"
  type    = "TXT"
  ttl     = 3000
...
# MX Records
resource "cloudflare_record" "dropdrape_mx_primary" {
  zone_id  = local.dropdrape_zone_id
  name     = "@"
...
resource "cloudflare_record" "dropdrape_mx_secondary" {
  zone_id  = local.dropdrape_zone_id
  name     = "@"
...
# SPF Record
resource "cloudflare_record" "dropdrape_spf" {
  zone_id = local.dropdrape_zone_id
  name    = "@"
...
# DKIM Records
resource "cloudflare_record" "dropdrape_dkim_key1" {
  zone_id = local.dropdrape_zone_id
  name    = "key1._domainkey"
  content = "key1.dropdrape.com.au._domainkey.migadu.com"
  type    = "CNAME"
  ttl     = 3000
  proxied = false
...
resource "cloudflare_record" "dropdrape_dkim_key2" {
  zone_id = local.dropdrape_zone_id
  name    = "key2._domainkey"
  content = "key2.dropdrape.com.au._domainkey.migadu.com"
  type    = "CNAME"
  ttl     = 3000
  proxied = false
...
resource "cloudflare_record" "dropdrape_dkim_key3" {
  zone_id = local.dropdrape_zone_id
  name    = "key3._domainkey"
  content = "key3.dropdrape.com.au._domainkey.migadu.com"
  type    = "CNAME"
  ttl     = 3000
  proxied = false
...
# DMARC Record
resource "cloudflare_record" "dropdrape_dmarc" {
  zone_id = local.dropdrape_zone_id
  name    = "_dmarc"
...
resource "cloudflare_record" "dropdrape_autoconfig" {
  zone_id = local.dropdrape_zone_id
  name    = "autoconfig"
...
resource "cloudflare_record" "dropdrape_autodiscover" {
  zone_id = local.dropdrape_zone_id
...
resource "cloudflare_record" "dropdrape_submissions" {
  zone_id = local.dropdrape_zone_id
...
resource "cloudflare_record" "dropdrape_imaps" {
  zone_id = local.dropdrape_zone_id
  name    = "_imaps._tcp"
  type    = "SRV"
  ttl     = 3000
...
resource "cloudflare_record" "dropdrape_pop3s" {
  zone_id = local.dropdrape_zone_id
  name    = "_pop3s._tcp"
  type    = "SRV"
  ttl     = 3000
